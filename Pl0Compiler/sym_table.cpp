...
void sym_table::init_keywords()
{
    ...
    _keywords.insert(pair<string, string>("int",       "INTSYM"));
    ...
    _keywords.insert(pair<string, string>("boolean",   "BOOLEANSYM"));
...
void sym_table::init_symbols()
{
    ...
    _symbols.insert(pair<string, string>("<",  "LTSYM"));
    _symbols.insert(pair<string, string>(">",  "GTSYM"));
    _symbols.insert(pair<string, string>("<=", "LESYM"));
    _symbols.insert(pair<string, string>(">=", "GESYM"));
